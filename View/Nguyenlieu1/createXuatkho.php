...
<body class="animsition">
    <div class="content">
        <div style="margin-left: 50px; padding-bottom: 15px; padding-top: 15px; display: inline-block;width: 1169px;">
                <h3 style="color: #000000; display: inline-block; font-size: 30px;">Thêm phiếu xuất kho</h3>
        </div>
        ...
        <div class="them" >
            <form action="" method="post" class="form-content">
                <div class="text-content">
                    ...
                    <div class="input-text">
                        <p>Mô tả</p>
                        <input type="text" name="description" class="textfiel" style="height:30px; width:300px;">
                    </div>

                    <div class="form-group">
                        <button type="submit" name="btnSave" class="btn btn-outline-success">Lưu</button>
                        <a href="Xuatkho.php" class="btn btn-outline-danger">Hủy</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <?php
        function InsertData() {
            ...
            if ($conn == false) {
                ...
                $query = "INSERT INTO export(ingredient_id, quantity, date, description) VALUES ('$ingredient_id', '$quantity', '$date', '$description')";
                $result = mysqli_query($conn, $query);
                if ($result == true) {
