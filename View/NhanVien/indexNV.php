...
<div class="content" >
    ...
    <div style="margin-left: 50px; padding-bottom: 15px; padding-top: 15px; display: inline-block;">
        ...
        <a href="createNV.php" class="btn btn-outline-info" style="display: inline-block; margin-left: 700px; background-color: #064928; color: white; font-size: 18px;">
    ...
    <div style="padding-left: 50px;padding-right: 50px;">
        <?php 
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo "<td>" ."<a href = 'editNV.php?id=".$row["id"]."' class='btn btn-outline-secondary'> Sửa</a>".
                "<a href = 'viewNV.php?id=".$row["id"]."' class='btn btn-outline-primary'>Xem chi tiết</a>"."</td>";
                echo "</tr>";
            }
            echo "</tbody></table>";
            }
...
<div style="margin-top: 10px; display: flex; justify-content: space-between;" >
            ...
            <?php 
                if ($current_page > 1 && $total_page > 1) {
                    echo '<a href="indexNV.php?page=' . ($current_page - 1) . '">&#171;</a> | ';
                }
                for ($i = 1; $i <= $total_page; $i++){
                    if ($i == $current_page){
                        ...
                        echo '<a href="indexNV.php?page='.$i.'">'.$i.'</a> |';
                    }
                }
