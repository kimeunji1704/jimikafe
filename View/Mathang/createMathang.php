...
<body class="animsition">
    <div class="content">
        <div style="margin-left: 50px; padding-bottom: 15px; padding-top: 15px; display: inline-block;width: 1169px;">
                <h3 style="color: #000000; display: inline-block; font-size: 30px;">Thêm mới sản phẩm</h3>
        </div>
            ...
            <form action="" method="post" class="form-content">
                <div class="text-content">
                    <div class="input-text">
                        <form method="post">
                            <p>Danh mục<span class="note" style="color:crimson">(*)</span></p>
                            <select id="category_id" name="category_id" class="textfiel" style="height:30px; width:200px;">
                                <?php echo $options; ?>
                            </select>
                        </form> 
                    </div>
                    ...
                    <div class="input-text">
                        ...
                        <input type="text" placeholder="Nhập tên sản phẩm" name="product_name" class="textfiel" style="height:30px; width:300px;">
                    </div>

                    <div class="input-text">
                        <p>Giá<span class="note" style="color:crimson">(*)</span></p>
                        <input type="text" placeholder="Nhập giá sản phẩm" name="unit_price" class="textfiel" style="height:30px; width:300px;">
                    </div>
    ...
    <?php
        function InsertData() {
            ...
            if ($conn == false) {
                ...
                $query = "INSERT INTO product(category_id, product_name, unit_price) VALUES ('$category_id', '$product_name', '$unit_price')";
                $result = mysqli_query($conn, $query);
                if ($result == true) {
