...
<div class="content" >
    ...
    <div style="margin-left: 50px; padding-bottom: 15px; padding-top: 15px; display: inline-block;">
        <h3 style="color: #000000; display: inline-block; font-size: 35px;">Danh sách ca làm</h3>
        <a href="createCa.php" class="btn btn-outline-info" style="display: inline-block; margin-left: 700px; background-color: #064928; color: white; font-size: 18px;">
    ...
    <div style="margin-top: 10px; padding-left: 50px;padding-right: 50px; display: flex; justify-content: space-between;" >
        <form method="Post" class="search">
            <input type="text" name="txtSearch" placeholder="Tìm kiếm theo tên nhân viên" style="width: 250px; border: 1px solid #000; font-size: 17px;"value="<?php echo isset($_POST['txtSearch']) ? $_POST['txtSearch'] : $TenKH ?>">
    ...
    <div style="padding-left: 50px;padding-right: 50px;">
        <?php 
            ...
            $result = mysqli_query($conn, 'SELECT COUNT(id) AS total FROM shifts');
            ...
            if (isset($_POST['txtSearch'])) {
                ...
                $query = "SELECT shifts.id, employees.name, shifts.startime, shifts.endtime, shifts.date, shifts.total_hours  
                          FROM shifts 
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                $startimeObject = new DateTime($startime);
                echo "<td>" . $startimeObject->format('H:i') . "</td>";
                //endtime
                $endtime = $row["endtime"]; 
...
<div style="margin-top: 10px; display: flex; justify-content: space-between;" >
            ...
            <?php 
                if ($current_page > 1 && $total_page > 1) {
                    echo '<a href="indexCa.php?page=' . ($current_page - 1) . '">&#171;</a> | ';
                }
                for ($i = 1; $i <= $total_page; $i++){
                    if ($i == $current_page){
                        ...
                        echo '<a href="indexCa.php?page='.$i.'">'.$i.'</a> |';
                    }
                }
