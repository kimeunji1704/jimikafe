                ...
                <form action="" method="post" class="form-content">
                    <div class="text-content">
                        <div class="input-text">
                            <p>Mã nhân viên</p>
                            <input type="text" name="id" class="textfiel" value="<?php echo isset($_POST['id']) ? $_POST['id']:$id ?>" readonly>
                        </div>

                        <div class="input-text">
                            <p>Tên nhân viên</p>
                            <input type="text" name="name" class="textfiel" value="<?php echo isset($_POST['name']) ? $_POST['name']:$name ?>" readonly>
                        </div>
                        ...
                        <div class="input-text">
                            <p>Ngày sinh</p>
                            <input type="date" name="birth" class="textfiel" value="<?php echo isset($_POST['birth']) ? $_POST['birth']:$birth ?>" readonly>
                        </div>
                        ...
                        <div class="input-text">
                            <p>SĐT</p>
                            <input type="text" name="phone" class="textfiel" value="<?php echo isset($_POST['phone']) ? $_POST['phone']:$phone ?>" readonly>
                        </div>

                        <div class="input-text">
                            <p>Địa Chỉ</p>
                            <input type="text" name="address" class="textfiel" value="<?php echo isset($_POST['address']) ? $_POST['address']:$address ?>" readonly>
                        </div>

                        <div class="form-group">
                            <a href="editTTCN.php" class="btn btn-outline-success" style="width: 100px;">Sửa</a>
                        </div>
                    </div>
                </form>
            </div>
