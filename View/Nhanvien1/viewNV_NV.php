...
<body class="animsition">
    ...
    <div class="content">
        ...
        <div style="margin-left: 50px; padding-bottom: 15px; padding-top: 15px; display: inline-block;width: 1169px;">
            <h3 style="color: #000000; display: inline-block; font-size: 30px;">Thông tin chi tiết nhân viên</h3>
        </div>
                ...
                <form action="" method="post" class="form-content">
                    <div class="text-content">
                        ...
                        <div class="input-text">
                            ...
                            <input type="text" name="txtname" class="textfiel" style="width: 200px; height: 30px;" value="<?php echo isset($_POST['txtname']) ? $_POST['txtname'] : $name ?>"readonly>
                        </div>
                        ...
                        <script>
                            document.getElementById("sex").addEventListener("mousedown", function (e) {
                                e.preventDefault();
                            });
                        </script>
                        ...
                        <div class="input-text">
                            ...
                            <div class="ui-select__wrapper next-input--has-content" style="width: 200px; height: 30px;">
                                <select id="txtchucvu" name="txtchucvu" class="ui-select" style="width:200px; height:30px;">
                        ...
                        <script>
                            document.getElementById("txtchucvu").addEventListener("mousedown", function (e) {
                                e.preventDefault();
                            });
                        </script>
                        ...
                        <div class="input-text">
                            ...
                            <input type="text" name="txtphone" class="textfiel" style="width: 200px; height: 30px;" value="<?php echo isset($_POST['txtphone']) ? $_POST['txtphone']:$phone ?>" readonly>
                        </div>

                        <div class="input-text">
                            <p>Địa chỉ</p>
                            <input type="text" name="address" class="textfiel" style="width: 200px; height: 30px;" value="<?php echo isset($_POST['address']) ? $_POST['address']:$address ?>" readonly>
                        </div>

                        <div class="form-group" style="margin-left: 200px">
                            <a href="indexNV_NV.php" class="btn btn-outline-danger">Quay lại</a>
                        </div>
                    </div>
                </form>
            </div>
