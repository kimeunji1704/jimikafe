             ...
             <div class="table">
                <form action="" method="post" class="form-content">
                    <div class="text-content">
                        ...
                        <div class="input-text">
                            <p>Sản phẩm</p>
                            <select id="product_id" name="product_id" value="" style="height:30px; width:200px;"> 
                                <?php echo $options; ?>
                            </select>
                        </div>
                        ...
                        <div class="input-text">
                            <p>Số lượng</p>
                            <input type="number" name="quantity" id="quantity" class="textfiel">
                        </div>

                        <div class="input-text">
                            <p>Tổng tiền</p>
                            <input type="text" name="total_amount" id="total_amount" class="textfiel" readonly>
                        </div>
                        <p id="log"></p>

                        <div class="form-group">
                            <button type="button" name="btnCalculateSalary" class="btn btn-outline-success" onclick="CalculateSalary()">Tính tiền</button>
